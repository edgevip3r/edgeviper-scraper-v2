// bettypes/FOOTBALL_WIN_TO_NIL/pricer.js — strict: all legs must price
...
export function price({ offer, mappedLegs, books }, ctx = {}) {
  ...
  if (debug && !allMids) {
    ...
    console.log(`[pricer:FOOTBALL_WIN_TO_NIL] partial mapping -> expected=${expected} have=${have} (missing=${missing})`);
  }
